  ...
  return (
    <div className="min-h-screen bg-neutral-50 text-neutral-900 font-sans flex">
      ...
      <main className="flex-1 overflow-y-auto">
        {/* Header */}
        <header className="h-20 bg-white border-b border-neutral-200 flex items-center justify-between px-4 md:px-8 sticky top-0 z-10">
          <div className="flex items-center gap-4 flex-1">
            <Link to="/" className="flex items-center gap-2 text-neutral-500 hover:text-brand transition-colors font-medium text-sm whitespace-nowrap">
          ...
          <div className="flex items-center gap-4 ml-4">
            ...
            <div className="w-10 h-10 bg-neutral-100 rounded-full border border-neutral-200 overflow-hidden shrink-0">
