...
export default function LuminaPreview() {
  ...
  const iframeUrl = "https://koenfelder.github.io/LuminaArchitects/";
  const content = CASE_STUDIES['lumina']!;
    ...
    <div className="flex flex-col h-screen bg-neutral-900 overflow-hidden">
      ...
      <header className="h-16 bg-white border-b border-neutral-200 flex items-center justify-between px-6 z-20 shrink-0">
        <div className="flex items-center gap-4">
          ...
          <h1 className="font-bold text-neutral-900 hidden sm:block">Lumina Architects</h1>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button 
            onClick={() => {
              setLoading(true);
              const iframe = document.getElementById('lumina-iframe') as HTMLIFrameElement;
        ...
        {loading && (
          <div className="absolute inset-0 flex items-center justify-center bg-white z-10">
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-neutral-500 font-medium animate-pulse">Loading Lumina Experience...</p>
            </div>
          </div>
        )}
